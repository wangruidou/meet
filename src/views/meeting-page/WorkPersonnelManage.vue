    ...
    data () {
        return {
            ...
            personColumns: [
                ...
                {title: '关注时间', key: 'inserttime', width: 160, align: 'center'},
                { title: '操作',
                    key: 'action',
                    align: 'center',
                    render: (h, params) => {
    ...
    methods: {
        ...
        savePerson2 () {
            ...
            this.$ajax.post('guestperson/query',
                ...
                '&salesman_query=' + this_.salesman_query + '' + '&persontype=' + "2")
                .then(function (response) {
